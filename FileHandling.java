...
public class filehandling {
	...
	public boolean createFile(String fileName){
		File file  = new File("D://java phaase 1/"+fileName);
		try {
			file.createNewFile();
	...
	public boolean updateFile(String fileName) throws IOException{
		...
		//FileWriter fos = new FileWriter("D://java phaase 1/"+fileName);
		File file = new File("D://java phaase 1/"+fileName);
	...
	public String[] getFilesinAscending() throws FileException {
		...
		File file = new File("D://java phaase 1/");
	...
	public void readFile(String fileName) throws IOException{
		...
		FileInputStream fis =new FileInputStream("D://java phaase 1/"+fileName);
