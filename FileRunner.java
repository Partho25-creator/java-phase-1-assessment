...
public class FileHandling extends FileHandeling {

	}

public static void makeDirectory() throws IOException {
		
		Path path = Paths.get("D://java phaase 1/");
		...
		public static void main(String[] args) throws IOException {
			...
			FileHandeling fh = new FileHandling();

			System.out.println("--------------------------------------------------------");
			System.out.println("Company Lockers Pvt. Ltd. developed by Partho Amit Acharya");
